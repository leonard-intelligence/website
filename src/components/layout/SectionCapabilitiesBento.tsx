...
export function SectionCapabilitiesBento() {
    ...
    return (
        <section ref={sectionRef} id="section-capabilities" className="py-24 bg-black border-t border-b border-white/10 -mr-px relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-[#e67d23]/5 blur-[120px] -z-10 rounded-full" />

            <div className="max-w-7xl mx-auto px-6 relative z-10">

                {/* Header */}
                <div className="flex flex-col mb-16 items-center text-center">
                    <span className="text-[#e67d23] text-sm tracking-widest uppercase mb-4 flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {capabilities.map((item, index) => (
                        <TechCard
                            ...
                            style={{ "--hover-border-color": "#e67d23" } as CSSProperties}
                        >
                            <div className="relative z-10 flex flex-col h-full">
                                {/* Icon & Tag */}
                                <div className="flex items-start justify-between mb-6">
                                    <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-[#e67d23] group-hover:scale-110 transition-transform duration-300">
                                        <DotIcon icon={leonardIcons.sparkles} size={20} fillColor="#e67d23" />
                                    </div>
                                ...
                                <div className="mt-auto">
                                    <h3 className="text-xl font-mono text-white mb-3 group-hover:text-[#e67d23] transition-colors">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-4">
                                        {item.features?.map((feat, i) => (
                                            <div key={i} className="flex items-center gap-2 text-zinc-400 text-[10px] uppercase tracking-wide">
                                                <div className="w-1 h-1 bg-[#e67d23] rounded-full" />
                                                {feat.label}
                                            </div>
                                        ))}
                                    </div>
